...
enum tu_predicate_bit {
   ...
   TU_PREDICATE_SUBSAMPLED_FAST_STORE = 6,
   TU_PREDICATE_SUBSAMPLED_NO_FAST_STORE = 7,
   TU_PREDICATE_NON_SUBSAMPLED_FAST_STORE = 8,
   TU_PREDICATE_NON_SUBSAMPLED_NO_FAST_STORE = 9,
};
